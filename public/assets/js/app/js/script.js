$(document).ready(function () {
    ...
    if ($('#mat').length && $('#mat').val().trim() !== '') {
        urlHistorique($('#mat').val().trim());
    }
    ...
    window.preloader = function () {
        ...
        var modalHtml = `
            <div class="modal fade" id="modalCharge" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        var modalElement = $("#modalCharge")[0];
